    ...
    <div class="card-body">
        ...
        <form action="{{ route('deaths.store') }}" method="POST" id="deathForm">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    <label class="form-label">Full Name of Deceased</label>
                    <input type="text" name="full_name" class="form-control @error('full_name') is-invalid @enderror" value="{{ old('full_name') }}" required>
                </div>

                <div class="col-md-12">
                    <label class="form-label">Place of Birth (of the Deceased)</label>
                    <input type="text" name="place_of_birth" class="form-control @error('place_of_birth') is-invalid @enderror" value="{{ old('place_of_birth') }}" required placeholder="Enter birthplace">
                </div>
            ...
            <div class="mt-4">
                <button type="submit" id="save_btn" class="btn btn-primary px-4" disabled>Save Death Record</button>
